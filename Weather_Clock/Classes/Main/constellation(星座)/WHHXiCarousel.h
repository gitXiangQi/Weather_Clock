...
@interface WHHXiCarousel : UIView
...
- (UIView *)carousel:(WHHXiCarousel *)carousel viewForItemAtIndex:(NSInteger)index reusingView:(nullable UIView *)view;
@optional
- (NSInteger)numberOfPlaceholdersInCarousel:(WHHXiCarousel *)carousel;
- (UIView *)carousel:(WHHXiCarousel *)carousel placeholderViewAtIndex:(NSInteger)index reusingView:(nullable UIView *)view;
@end
@protocol iCarouselDelegate <NSObject>
@optional
- (void)carouselWillBeginScrollingAnimation:(WHHXiCarousel *)carousel;
- (void)carouselDidEndScrollingAnimation:(WHHXiCarousel *)carousel;
- (void)carouselDidScroll:(WHHXiCarousel *)carousel;
- (void)carouselCurrentItemIndexDidChange:(WHHXiCarousel *)carousel;
- (void)carouselWillBeginDragging:(WHHXiCarousel *)carousel;
- (void)carouselDidEndDragging:(WHHXiCarousel *)carousel willDecelerate:(BOOL)decelerate;
- (void)carouselWillBeginDecelerating:(WHHXiCarousel *)carousel;
- (void)carouselDidEndDecelerating:(WHHXiCarousel *)carousel;
- (BOOL)carousel:(WHHXiCarousel *)carousel shouldSelectItemAtIndex:(NSInteger)index;
- (void)carousel:(WHHXiCarousel *)carousel didSelectItemAtIndex:(NSInteger)index;
- (CGFloat)carouselItemWidth:(WHHXiCarousel *)carousel;
- (CATransform3D)carousel:(WHHXiCarousel *)carousel itemTransformForOffset:(CGFloat)offset baseTransform:(CATransform3D)transform;
