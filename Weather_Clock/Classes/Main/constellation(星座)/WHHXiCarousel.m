...
#endif
@implementation NSObject (WHHXiCarousel)
- (NSUInteger)numberOfPlaceholdersInCarousel:(__unused WHHXiCarousel *)carousel { return 0; }
- (void)carouselWillBeginScrollingAnimation:(__unused WHHXiCarousel *)carousel {}
- (void)carouselDidEndScrollingAnimation:(__unused WHHXiCarousel *)carousel {}
- (void)carouselDidScroll:(__unused WHHXiCarousel *)carousel {}
- (void)carouselCurrentItemIndexDidChange:(__unused WHHXiCarousel *)carousel {}
- (void)carouselWillBeginDragging:(__unused WHHXiCarousel *)carousel {}
- (void)carouselDidEndDragging:(__unused WHHXiCarousel *)carousel willDecelerate:(__unused BOOL)decelerate {}
- (void)carouselWillBeginDecelerating:(__unused WHHXiCarousel *)carousel {}
- (void)carouselDidEndDecelerating:(__unused WHHXiCarousel *)carousel {}
- (BOOL)carousel:(__unused WHHXiCarousel *)carousel shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)carousel:(__unused WHHXiCarousel *)carousel didSelectItemAtIndex:(__unused NSInteger)index {}
- (CGFloat)carouselItemWidth:(__unused WHHXiCarousel *)carousel { return 0; }
- (CATransform3D)carousel:(__unused WHHXiCarousel *)carousel
   itemTransformForOffset:(__unused CGFloat)offset
            baseTransform:(CATransform3D)transform { return transform; }
- (CGFloat)carousel:(__unused WHHXiCarousel *)carousel
     valueForOption:(__unused iCarouselOption)option
        withDefault:(CGFloat)value { return value; }
@end
@interface WHHXiCarousel ()
...
NSComparisonResult compareViewDepth(UIView *view1, UIView *view2, WHHXiCarousel *self);
@end
@implementation WHHXiCarousel
#pragma mark -
